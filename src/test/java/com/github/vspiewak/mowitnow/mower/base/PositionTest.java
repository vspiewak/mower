...
public class PositionTest {
    ...
    public void given_position_1_2_north_next_forward_expect_1_3() {
        ...
        assertThat(newPosition(1, 2).next(Move.FORWARD, Orientation.NORTH)).isEqualTo(newPosition(1, 3));
    }

    @Test
    public void given_position_1_2_south_next_forward_expect_1_1() {

        assertThat(newPosition(1, 2).next(Move.FORWARD, Orientation.SOUTH)).isEqualTo(newPosition(1, 1));
    }

    @Test
    public void given_position_1_2_east_next_forward_expect_2_2() {

        assertThat(newPosition(1, 2).next(Move.FORWARD, Orientation.EAST)).isEqualTo(newPosition(2, 2));
    }

    @Test
    public void given_position_1_2_west_next_forward_expect_0_2() {

        assertThat(newPosition(1, 2).next(Move.FORWARD, Orientation.WEST)).isEqualTo(newPosition(0, 2));
